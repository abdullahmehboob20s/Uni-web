    ...
    <div className={styles.wrapper}>
      <div className="container-wrapper-2">
        <div className={styles.footer}>
          ...
          <div className={`${styles.footerColumn} mb-70px`}>
            ...
            <div className={styles.desc}>
              ...
              <p className="font-secondary white fs-16px white lh-1_8">
                uniBond is the first-ever company to provide designing services
                for IPFS and Blockchain. uniBond is the first-ever company to
                provide designing services for IPFS and Blockchain. uniBond is
                the first-ever company to provide designing services.
              </p>
            </div>
          ...
          <div className={`${styles.footerLinks} mb-40px`}>
            ...
            <div className={`${styles.SocialLinks}`}>
              ...
              <a href="#">
                <FaTwitter color="white" size={34} />
              </a>
              <a href="#">
                <BsDiscord color="white" size={32} />
              </a>
              <a href="#">
                <MdEmail color="white" size={34} />
              </a>
              <a href="#">
                <FaInstagram color="white" size={34} />
              </a>
              <a href="#">
                <BsLinkedin color="white" size={30} />
              </a>
              <a href="#">
                <BsGithub color="white" size={34} />
              </a>
            </div>
          </div>
